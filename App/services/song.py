'''
Song class for managing song data and file generation.
Handles creation of Sonic Pi code files and song directories.
'''
import os
import re
...
class Song:
    ...
    def create_song_file(self, song_creation_data):
        ...
        header = f"# --{self.name.upper()}-- \n# Generated by Coded Music Scoring with Sonic Pi. \n\n"
